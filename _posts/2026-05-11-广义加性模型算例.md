...
<div style="text-align: center;">
    <img src="{{ '/images/_posts/2026-05-11-广义加性模型算例/图1_测试数据.png' | relative_url }}" width="700" />
</div>
...
<div style="text-align: center;">
    <img src="{{ '/images/_posts/2026-05-11-广义加性模型算例/图2_同方差GAM效果.png' | relative_url }}" width="700" />
</div>
...
<div style="text-align: center;">
    <img src="{{ '/images/_posts/2026-05-11-广义加性模型算例/图3_同异方差GAM效果对比.png' | relative_url }}" width="1000" />
</div>

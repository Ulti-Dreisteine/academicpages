...
罗磊，长期从事化学工程与过程系统工程相关研究、工程实践与技术开发，研究兴趣聚焦于因果推断、非线性过程建模、系统辨识、时间序列分析与机器学习在复杂工业过程中的应用。
...
- 邮箱：dreisteine262@163.com
- 邮箱：dreisteine262@gmail.com
...
1. [发明] 一种超超临界锅炉三级过热减温水协同控制系统及其方法, 2025（审中）
2. [发明] 一种基于MESC的锅炉系统闭环多目标优化方法及相关设备, 2025（审中）
3. [发明] 一种白酒智慧蒸馏工艺参数的优化方法, 2025（审中）
4. [发明] 基于深度学习的高温大曲发酵过程温度预测方法, 2025（审中）
5. [发明] 一种燃煤机组协调级PID与模型预测控制回路解耦控制方法, 2024（审中）
6. [发明] 一种污染物浓度的预测模型训练方法、预测方法及装置, 2020（有效）
7. [发明] 一种复合脱硫装置石膏浆液密度测量方法及测量系统, 2020（有效）
8. [发明] 一种脱硫优化方法、装置、电子设备及存储介质, 2020（有效）
9. [发明] 基于高斯回归的大气污染物浓度的预测方法及装置, 2020（失效）
...
2. 百度天池国家电网调控 AI 创新大赛：新能源发电预测，参与人
3. 阿里天池比赛：面料裁剪利用率优化，参与